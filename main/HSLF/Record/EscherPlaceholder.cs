...
namespace NPOI.HSLF.Record
{
     ...
     */
    public class EscherPlaceholder : EscherRecord {
    public static short RECORD_ID = RecordTypes.OEPlaceholderAtom.typeID;
    public static String RECORD_DESCRIPTION = "msofbtClientTextboxPlaceholder";
