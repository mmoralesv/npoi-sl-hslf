...
namespace NPOI.HSLF.Record
{
    ...
    public class UserEditAtom : PositionDependentRecordAtom
{
    public static int LAST_VIEW_NONE = 0;
    public static int LAST_VIEW_SLIDE_VIEW = 1;
    public static int LAST_VIEW_OUTLINE_VIEW = 2;
    public static int LAST_VIEW_NOTES = 3;

    private byte[] _header;
    private static long _type = RecordTypes.UserEditAtom.typeID;
