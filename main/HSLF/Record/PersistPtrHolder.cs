...
namespace NPOI.HSLF.Record
{
    ...
    private static BitField persistIdFld = BitFieldFactory.getInstance(0X000FFFFF);
    private static BitField cntPersistFld  = BitFieldFactory.getInstance(0XFFF00000);
