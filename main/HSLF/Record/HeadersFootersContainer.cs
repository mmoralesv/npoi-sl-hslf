...
namespace NPOI.HSLF.Record
{
     ...
     * </ul>
     */
    public class HeadersFootersContainer : RecordContainer
    {
     ...
     */
    public static short SlideHeadersFootersContainer = 0x3F;
    /**
      * "instance" field in the record header indicating that this HeadersFootersContaine
     *   is applied for notes and handouts
      */
    public static short NotesHeadersFootersContainer = 0x4F;

    public static int USERDATEATOM = 0;
    public static int HEADERATOM = 1;
    public static int FOOTERATOM = 2;
