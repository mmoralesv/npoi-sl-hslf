...
namespace NPOI.HSLF.Record
{
     ...
     */
    public class ExOleObjAtom : RecordAtom {
    ...
    private static int[] DRAWASPECT_MASKS = {
        0x0001, 0x0002, 0x0004, 0x0008
    };

    private static String[] DRAWASPECT_NAMES = {
        "CONTENT", "THUMBNAIL", "ICON", "DOCPRINT"
    };

    //arbitrarily selected; may need to increase
    private static int MAX_RECORD_LENGTH = 10_485_760;

    /**
     * The object) is displayed as an embedded object inside of a container,
     */
    public static int DRAW_ASPECT_VISIBLE = 1;
    /**
     *   The object is displayed as a thumbnail image.
     */
    public static int DRAW_ASPECT_THUMBNAIL = 2;
    /**
     *   The object is displayed as an icon.
     */
    public static int DRAW_ASPECT_ICON = 4;
    /**
     *   The object is displayed on the screen as though it were printed to a printer.
     */
    public static int DRAW_ASPECT_DOCPRINT = 8;

    /**
     * An embedded OLE object; the object is serialized and saved within the file.
     */
    public static int TYPE_EMBEDDED = 0;
    /**
     * A linked OLE object; the object is saved outside of the file.
     */
     ...
     * The OLE object is an ActiveX control.
     */
    public static int TYPE_CONTROL = 2;

    public static int SUBTYPE_DEFAULT = 0;
    public static int SUBTYPE_CLIPART_GALLERY = 1;
    public static int SUBTYPE_WORD_TABLE = 2;
    public static int SUBTYPE_EXCEL = 3;
    public static int SUBTYPE_GRAPH = 4;
    public static int SUBTYPE_ORGANIZATION_CHART = 5;
    public static int SUBTYPE_EQUATION = 6;
    public static int SUBTYPE_WORDART = 7;
    public static int SUBTYPE_SOUND = 8;
    public static int SUBTYPE_IMAGE = 9;
    public static int SUBTYPE_POWERPOINT_PRESENTATION = 10;
    public static int SUBTYPE_POWERPOINT_SLIDE = 11;
    public static int SUBTYPE_PROJECT = 12;
    public static int SUBTYPE_NOTEIT = 13;
    public static int SUBTYPE_EXCEL_CHART = 14;
    public static int SUBTYPE_MEDIA_PLAYER = 15;
