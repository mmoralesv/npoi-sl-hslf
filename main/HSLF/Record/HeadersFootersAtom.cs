...
namespace NPOI.HSLF.Record
{
    ...
    public class HeadersFootersAtom : RecordAtom
    {
     ...
     * @see #setMask(int)
     */
    public static int fHasTodayDate = 2;
     ...
     * @see #setMask(int)
     */
    public static int fHasUserDate = 4;
     ...
     * @see #setMask(int)
     */
    public static int fHasSlideNumber = 8;
     ...
     * @see #setMask(int)
     */
    public static int fHasHeader = 16;
     ...
     * @see #setMask(int)
     */
    public static int fHasFooter = 32;

    private static int[] PLACEHOLDER_MASKS = {
        fHasDate,
        fHasTodayDate,
        fHasUserDate,
        fHasSlideNumber,
    ...
    private static String[] PLACEHOLDER_NAMES = {
