 ...
 * -->
 */
    public class ExEmbedAtom : RecordAtom {

    /**
     * Embedded document does not follow the color scheme.
     */
    public static int DOES_NOT_FOLLOW_COLOR_SCHEME = 0;

    /**
     * Embedded document follows the entire color scheme.
     */
    public static int FOLLOWS_ENTIRE_COLOR_SCHEME = 1;

    /**
     * Embedded document follows the text and background scheme.
     */
    public static int FOLLOWS_TEXT_AND_BACKGROUND_SCHEME = 2;
