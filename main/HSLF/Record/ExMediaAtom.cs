...
namespace NPOI.HSLF.Record
{
     ...
     */
    public static int fNarration = 4;


    private static int[] FLAG_MASKS = { fLoop, fRewind, fNarration };

    private static String[] FLAG_NAMES = { "LOOP", "REWIND", "NARRATION" };
