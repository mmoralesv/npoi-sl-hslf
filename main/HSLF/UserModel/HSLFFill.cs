...
public class HSLFFill {
    private static Logger LOG = LogManager.getLogger(HSLFFill.class);

    /**
     *  Fill with a solid color
     */
    static int FILL_SOLID = 0;

    /**
     *  Fill with a pattern (bitmap)
     */
    static int FILL_PATTERN = 1;

    /**
     *  A texture (pattern with its own color map)
     */
    static int FILL_TEXTURE = 2;

    /**
     *  Center a picture in the shape
     */
    static int FILL_PICTURE = 3;

    /**
     *  Shade from start to end points
     */
    static int FILL_SHADE = 4;

    /**
     *  Shade from bounding rectangle to end point
     */
    static int FILL_SHADE_CENTER = 5;

    /**
     *  Shade from shape outline to end point
     */
    static int FILL_SHADE_SHAPE = 6;
     ...
     */
    static int FILL_SHADE_SCALE = 7;

    /**
     *  shade to title
     */
    static int FILL_SHADE_TITLE = 8;

    /**
     *  Use the background fill color/pattern
     */
    static int FILL_BACKGROUND = 9;
     ...
     */
    private static BitField FILL_USE_RECOLOR_FILL_AS_PICTURE = BitFieldFactory.getInstance(0x00400000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_USE_SHAPE_ANCHOR = BitFieldFactory.getInstance(0x00200000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_FILLED = BitFieldFactory.getInstance(0x00100000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_HIT_TEST_FILL = BitFieldFactory.getInstance(0x00080000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_FILL_SHAPE = BitFieldFactory.getInstance(0x00040000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_FILL_USE_RECT = BitFieldFactory.getInstance(0x00020000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_NO_FILL_HIT_TEST = BitFieldFactory.getInstance(0x00010000);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_RECOLOR_FILL_AS_PICTURE = BitFieldFactory.getInstance(0x00000040);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_USE_SHAPE_ANCHOR = BitFieldFactory.getInstance(0x00000020);
     ...
     */
    private static BitField FILL_FILLED = BitFieldFactory.getInstance(0x00000010);
     ...
     */
    private static BitField FILL_HIT_TEST_FILL = BitFieldFactory.getInstance(0x00000008);
     ...
     * The default value for this property is 0x1.
     */
    private static BitField FILL_FILL_SHAPE = BitFieldFactory.getInstance(0x00000004);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_FILL_USE_RECT = BitFieldFactory.getInstance(0x00000002);
     ...
     * The default value for this property is 0x0.
     */
    private static BitField FILL_NO_FILL_HIT_TEST = BitFieldFactory.getInstance(0x00000001);
    ...
    private GradientPaint getGradientPaint(final GradientType gradientType) {
        ...
        if (focus == 100 || focus == -100) {
            ...
            List<Float> fractRev = new ArrayList<>();
    ...
    private TexturePaint getTexturePaint() {
        HSLFPictureData pd = getPictureData();
        if (pd == null) {
            return null;
        }
