...
namespace NPOI.HSLF.UserModel
{
     ...
     */
    public class HSLFGroupShape : HSLFShape
implements HSLFShapeContainer, GroupShape<HSLFShape,HSLFTextParagraph> {
    private static Logger LOG = LogManager.getLogger(HSLFGroupShape.class);
    ...
    @Override
    public <T : EscherRecord> T getEscherChild(int recordId){
