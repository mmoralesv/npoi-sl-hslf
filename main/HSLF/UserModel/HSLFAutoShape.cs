...
namespace NPOI.HSLF.UserModel
{
     ...
     * See {@link ShapeTypes}
     */
    public class HSLFAutoShape : HSLFTextShape implements AutoShape<HSLFShape,HSLFTextParagraph> {
    private static Logger LOG = LogManager.getLogger(HSLFAutoShape.class);

    static byte[] SEGMENTINFO_MOVETO   = new byte[]{0x00, 0x40};
    static byte[] SEGMENTINFO_LINETO   = new byte[]{0x00, (byte)0xAC};
    static byte[] SEGMENTINFO_ESCAPE   = new byte[]{0x01, 0x00};
    static byte[] SEGMENTINFO_ESCAPE2  = new byte[]{0x01, 0x20};
    static byte[] SEGMENTINFO_CUBICTO  = new byte[]{0x00, (byte)0xAD};
    // OpenOffice inserts 0xB3 instead of 0xAD.
    // protected static byte[] SEGMENTINFO_CUBICTO2 = new byte[]{0x00, (byte)0xB3};
    static byte[] SEGMENTINFO_CLOSE    = new byte[]{0x01, (byte)0x60};
    static byte[] SEGMENTINFO_END      = new byte[]{0x00, (byte)0x80};
    ...
    CustomGeometry getGeometry(Path2D path2D) {
        ...
        Rectangle2D bounds = getBounds(opt, path2D);
