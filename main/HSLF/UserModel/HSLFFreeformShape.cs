...
namespace NPOI.HSLF.UserModel
{
     ...
     * </p>
     */
    public class HSLFFreeformShape : HSLFAutoShape implements FreeformShape<HSLFShape,HSLFTextParagraph> {
    private static Logger LOG = LogManager.getLogger(HSLFFreeformShape.class);
