...
namespace NPOI.HSLF.UserModel
{
     ...
     */
    public class HSLFHyperlink implements Hyperlink<HSLFShape,HSLFTextParagraph> {
    ...
    private static void find(List<? : Record> records, ExObjList exobj, List<HSLFHyperlink> out){
