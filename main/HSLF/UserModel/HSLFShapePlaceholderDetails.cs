...
namespace NPOI.HSLF.UserModel
{
     ...
     * @since POI 4.0.0
     */
    public class HSLFShapePlaceholderDetails : HSLFPlaceholderDetails {
    private enum PlaceholderContainer {
        slide, master, notes, notesMaster
    }

    private PlaceholderContainer source;
    HSLFSimpleShape shape;
    ...
    public void setPlaceholder(final Placeholder placeholder) {
        EscherSpRecord spRecord = shape.getEscherChild(EscherSpRecord.RECORD_ID);
        ...
        byte phId = getPlaceholderId(placeholder);
    ...
    public PlaceholderSize getSize() {
        ...
        int size = (oePlaceholderAtom != null)
    ...
    private void removePlaceholder() {
        HSLFEscherClientDataRecord clientData = shape.getClientData(false);
        if (clientData != null) {
    ...
    private void updatePlaceholderAtom(final boolean create) {
        ...
        HSLFEscherClientDataRecord clientData = shape.getClientData(create);
        if (clientData == null) {
            oePlaceholderAtom = null;
            roundTripHFPlaceholder12 = null;
            if (!create) {
